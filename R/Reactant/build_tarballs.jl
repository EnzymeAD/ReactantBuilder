...
if [[ "${bb_full_target}" == *gpu+rocm* ]]; then
    ...
    sed -i -e "s,export LD_LIBRARY_PATH,PRE_FLAGS+=( -Wno-unused-command-line-argument -isystem/workspace/bazel_root/097636303b1142f44508c1d8e3494e4b/external/local_config_rocm/rocm/rocm_dist/lib/llvm/lib/clang/22/include/cuda_wrappers -isystem/workspace/bazel_root/097636303b1142f44508c1d8e3494e4b/external/local_config_rocm/rocm/rocm_dist/lib/llvm/lib/clang/22/include); export LD_LIBRARY_PATH,g" $ROCM_PATH/bin/hipcc
